...
public class frmCliente extends javax.swing.JFrame {
    ...
    private void mostrarIconos() {
        ...
        Image iconoCliente = new ImageIcon("Recursos\\Iconos\\iconoCliente2.png").getImage();
        ...
        UtilidadIcono.cargarIconoButtonRedimensionable(iconoGuardar, jbtnModificarCliente, 43, 43);

        Image iconoSalir = new ImageIcon("Recursos\\Iconos\\iconoSalir2.png").getImage();
        UtilidadIcono.cargarIconoButtonRedimensionable(iconoSalir, jtbnSalirCliente, 43, 43);
    }
