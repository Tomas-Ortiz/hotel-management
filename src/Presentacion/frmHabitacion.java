...
public class frmHabitacion extends javax.swing.JFrame {
    ...
    private void mostrarIconos() {
        ...
        Image iconoHabitacion = new ImageIcon("Recursos\\Iconos\\iconoHabitacion2.png").getImage();
        ...
        UtilidadIcono.cargarIconoButtonRedimensionable(iconoGuardar, jbtnGuardarHabitacion, 43, 43);

        Image iconoSalir = new ImageIcon("Recursos\\Iconos\\iconoSalir2.png").getImage();
        UtilidadIcono.cargarIconoButtonRedimensionable(iconoSalir, jtbnCancelarHabitacion, 43, 43);
    }
